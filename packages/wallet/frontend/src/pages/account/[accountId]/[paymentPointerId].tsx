...
<<<<<<< HEAD:packages/wallet-frontend/src/pages/account/[accountId]/[paymentPointerId].tsx
                  <Table.Cell>
                    {
                      formatAmount({
                        value: trx.value ?? 0,
...
>>>>>>> c5e9bd332ccc0a11b3ad0cd2b2aba7fccbdd6cfd:packages/wallet/frontend/src/pages/account/[accountId]/[paymentPointerId].tsx
                </Table.Row>
              ))
            ) : (
              <Table.Row>
