...
type ActivateCardActionProps = {
  card: IUserCard
}

export const ActivateCardAction = ({ card }: ActivateCardActionProps) => {
  ...
  return (
    <Button
      ...
      onClick={async () => {
        ...
        // cumbersome.
        openDialog(<ActivateCardDialog card={card} onClose={closeDialog} />)
      }}
    >
      Activate Card
    </Button>
