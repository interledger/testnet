...
const buttonStyles = cva(
  [
    'inline-flex items-center justify-center outline-none border-2 decoration-transparent transition-[box-shadow,background-color,text-decoration-color,color] duration-200 ease-in-out hover:decoration-[currentcolor] focus:decoration-[currentcolor] dark:hover:shadow-glow-button dark:focus:shadow-glow-button'
  ],
  {
    variants: {
      intent: {
