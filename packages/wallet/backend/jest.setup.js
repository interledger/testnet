...
module.exports = async () => {
  ...
  process.env.GATEHUB_IFRAME_MANAGED_RAMP_URL =
    'https://managed-ramp.sandbox.gatehub.net'
  process.env.GATEHUB_IFRAME_EXCHANGE_URL =
    'https://exchange.sandbox.gatehub.net'
  process.env.GATEHUB_IFRAME_ONBOARDING_URL =
