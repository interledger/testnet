...
export const mockCreateWalletRequest = (overrides?: Partial<CreateWalletRequest['body']>
): CreateWalletRequest => {
    return {
        body: {
...
export const mockedRapydFailureService = {
    getCountryNames: jest.fn().mockRejectedValueOnce(new Error('Unexpected error')),
    getDocumentTypes:jest.fn().mockRejectedValueOnce(new Error('Unexpected error')),
    createWallet: jest.fn().mockRejectedValueOnce(new Error('Unexpected error')),
    verifyIdentity: jest.fn().mockRejectedValueOnce(new Error('Unexpected error')),
...
export const mockedTransactionInsertObjs: Array<PartialModelObject<Transaction>> = [
