import {Asset, AssetEdge, AssetMutationResponse, AssetsConnection} from "../generated/graphql";
...
export async function createAsset(
  ...
  `
    ...
    return requestGQL<{ createAsset: AssetMutationResponse}>(createAssetMutation, createAssetInput, {})
        .then(({createAsset}) => {
...
export async function listAssets(): Promise<Asset[]> {
  ...
  `
    ...
    return requestGQL<{ assets: AssetsConnection }>(getAssetsQuery)
        .then((data) => {
...
export async function getAsset(id: string): Promise<Asset> {
  ...
  `
    ...
    return requestGQL<{asset: Asset}>(getAssetsQuery, { id })
        .then((data) => {
            return data.asset
        })
}
